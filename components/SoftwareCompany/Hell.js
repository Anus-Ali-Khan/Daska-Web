...
const Hell = () => {
  return (
    <div className="bg-[#E8ECFD] w-full min-h-screen flex flex-col justify-between items-center py-8">
      <div className="flex flex-col items-center w-full px-5 lg:gap-8">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4 lg:flex-row lg:justify-around">
          {/* left */}
          <div className="flex flex-col items-center justify-center w-full lg:flex-row lg:w-auto max-sm:flex max-sm:flex-row max-sm:gap-x-5 md:flex-row md:gap-x-5">
            {/* <div className="hidden lg:block bg-[#E8ECFD] w-48 h-4 lg:mb-16"></div> */}
            <Image
              src={LeftImage}
              className="w-48 mb-8 h-60 lg:h-112 lg:w-52 lg:mb-0"
              alt="Left Image"
            />
            <Image
              src={RightImage}
              className="w-48 mt-16 h-60 lg:h-112 lg:w-52 lg:mt-0 lg:ml-8"
              alt="Right Image"
            />
          </div>
