        ...
        <div className="w-full p-4 text-black lg:w-1/2 lg:p-8">
          ...
          <div className="flex flex-col mb-10 lg:flex-row gap-x-10">
            <div className="flex mb-6 gap-x-3 lg:mb-0">
              ...
              <div>
                <h1 className="font-bold text-white">Free estimation</h1>
            ...
            <div className="flex mb-6 gap-x-3 lg:mb-0">
              ...
              <div>
                <h1 className="font-bold text-white">On-budget</h1>
          ...
          <div className="flex flex-col mb-10 lg:flex-row gap-x-10">
            <div className="flex mb-6 gap-x-3 lg:mb-0">
              ...
              <div>
                <h1 className="font-bold text-white">Project workshops</h1>
            ...
            <div className="flex mb-6 gap-x-3 lg:mb-0">
              ...
              <div>
                <h1 className="font-bold text-white">Dedicated team</h1>
