...
const Store = () => {
  return (
    <div className="w-[100vw] h-[50rem] bg-[#E8ECFD] overflow-x-hidden flex justify-center items-center p-8 ">
      {/* Outer container */}
      <div className="bg-[#887CEC] w-[65rem] h-[30rem] rounded-lg flex justify-between items-center relative  ">
        {/* Image */}
        ...
        {/* right */}
        <div className="flex flex-col items-center justify-center max-sm:justify-center ">
          <div className="flex flex-col items-center justify-center">
            ...
            {/* Store Buttons */}
            <div className="flex items-center justify-center gap-8 mb-4 ml-[25rem] cursor-pointer max-sm:ml-0 max-sm:flex max-sm:flex-col ">
            ...
            {/* icon */}
            <div className="flex items-center justify-center ml-[20rem] mb-4 max-sm:ml-0 max-sm:flex-col">
