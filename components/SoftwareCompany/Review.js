  ...
  return (
    <div className="bg-[#E8ECFD] min-h-screen flex flex-col justify-between items-center p-6 lg:p-0">
      ...
      <div className="flex flex-col p-1 lg:ml-6 w-full lg:w-[27rem]">
        ...
        <div>
          <h1 className="text-[33px] w-full lg:w-[29rem] text-[#351A5F] leading-[41px] font-[Inter 500] font-semibold">
        ...
        <div className="mt-[3rem] flex flex-col">
          <p className="text-[16px] text-[#351A5F] leading-[25px] font-[Inter 500] font-semibold w-full lg:w-[29rem]">
