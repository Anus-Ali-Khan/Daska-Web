    ...
    <>
      <div className='w-[80%] mx-auto  h-[90vh] mt-10 flex gap-x-32 '>
        ...
        alt="Picture of the author" className='h-[80vh] w-half'/>
            ...
            <div className=' w-half right w-[50%]'>
            <div className='flex flex-col gap-y-8'>
                <p className='font-semibold text-slate-700'>OUR PROJECT</p>
                <h1><span className='text-3xl font-semibold tracking-wider'>All-inclusive crypto data  with</span> <br /><span className='text-3xl font-semibold tracking-wider'>usefull insights</span> </h1>
