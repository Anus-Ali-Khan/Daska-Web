        ...
        <div className='bg-black w-[300px] h-[600px]  rounded-l-2xl'>
          ...
          <div className='mt-[100px] ml-[90px]'>
            ...
            <div>
              ...
              <Link href="/"><li className='hover:text-white' onClick={hideSidebar}>Home</li></Link>
                <Link href="/aboutUs"><li className='hover:text-white' onClick={hideSidebar}>Pages</li></Link>
                <Link href="/portfolio"> <li className='flex items-center gap-x-2 ' onClick={hideSidebar}>Portfolio <MdWavingHand className='text-2xl text-orange-300'/></li></Link>
                <Link href="/blog"> <li className='hover:text-white' onClick={hideSidebar}>Blog</li></Link>
